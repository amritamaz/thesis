...
\begin{itemize}
  \item Chapter~\ref{ch:near-sensor}: \bibentry{amazumdar_iiswc17}
  \item Chapter~\ref{ch:hfbs}: \bibentry{amazumdar_hpg17}
  \item Chapter~\ref{ch:vignette}: \bibentry{vignette}
\end{itemize}
