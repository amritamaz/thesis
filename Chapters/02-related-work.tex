...
\subsection{Systems and Architecture for Visual Computing}

\subsubsection{Near-sensor processing for camera capture}
...
\subsubsection{Vision-centric specialized hardware accelerators}
...
\subsubsection{Hardware accelerators for virtual reality video capture}
...
\subsubsection{Video streaming and storage systems}
...
\subsubsection{Cloud video management and analytics}
...
\subsection{Perceptual Optimizations for Visual Computing}

\subsubsection{Approximate visual computing}
...
\subsubsection{Structural video data optimization}
...
\subsubsection{Semantics-based video optimization}
...
\subsubsection{Saliency-based video optimization}
