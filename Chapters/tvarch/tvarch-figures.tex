...
\begin{figure}
        \centering
        \includegraphics[width=.6\linewidth]{tvarch-figs/optimal-scheduling.pdf}
...
\includegraphics[width=.46\linewidth]{tvarch-figs/motiv-energy-cpu.pdf}
}
\hfill
...
\newcommand{\evalEnergyPower}{
  \begin{figure}
    \centering
    \includegraphics[width=.6\linewidth]{tvarch-figs/eval-energy-breakdown.pdf}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=.6\linewidth]{tvarch-figs/eval-power-energy-total.pdf}
