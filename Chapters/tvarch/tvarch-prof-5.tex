\section{Video Energy Estimates with the RabbitRun Framework}
\label{sec:vdoprof}
...
\subsubsection{Hardware Decoder Profiles}
...
\subsubsection{Video Encoding Constraints}
...
\subsubsection{Device Playback Constraints}
...
\subsubsection{Decode Energy Estimation}
...
\subsubsection{Hardware Accelerator Design Details}
