...
\begin{figure}[h]
  \centering
\includegraphics[width=.7\linewidth]{vignette-figs/storage-video-growth.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.8\textwidth]{vignette-figs/tiled-bitrate}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.7\textwidth]{vignette-figs/high-level-architecture}
...
\begin{figure}[h]
  ...
  \label{subfig:og-stil}
  \includegraphics[width=.25\linewidth]{vignette-figs/elfuente_in.png}
  }
  \quad
  \subfloat[Saliency map produced by MLNet~\cite{mlnet2016}, overlaid on input.]{
  \label{subfig:sal-still}
  \includegraphics[width=.25\linewidth]{vignette-figs/elfuente_sal.png}
  }
  \quad
  \subfloat[Perceptually-compressed \name video, 85\% smaller at iso-quality.]{
  \label{subfig:sal-vign}
  \includegraphics[width=.25\linewidth]{vignette-figs/elfuente_vignette.png}
  }
...
\begin{figure*}[h]
  \centering
    \includegraphics[width=\textwidth]{system-overview-open.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.7\linewidth]{vignette-figs/physical-layout}
